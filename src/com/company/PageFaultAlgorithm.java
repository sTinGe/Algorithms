...
public class PageFaultAlgorithm {
    ...
    public static enum Algorithm {
        ...
        FIFO, SECOND_CHANGE, LRU, OPTIMAL, RANDOM
    }
    ...
    public static void readPage(final Algorithm pageFaultAlgorithm, final int numberOfFrames, String... references) {
        ...
        switch (pageFaultAlgorithm) {
            ...
            case OPTIMAL:
                ...
                break;
            case RANDOM:
                numberOfPageFault = random(frames, numberOfFrames, references);
                break;
            default:
                numberOfPageFault = 0;
        }
    ...
    private static int random(final Frame frames[], final int numberOfFrames, final String... references) {
        ...
        for (int n = 0; n < numberOfReferences; ++n) {
            ...
            if (fault) {
                ...
                if (numberOfPageFault < numberOfFrames) {
                    // Choose next victim
                    victim = (victim + 1) % numberOfFrames;
                } else {
                    // Choose victim randomly
                    victim = (int) Math.floor(Math.random() * numberOfFrames);
                }
